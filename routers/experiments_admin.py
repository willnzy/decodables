"""
A/B Testing Experiments - Admin API

@module routers.experiments_admin
@version 3.24

Admin Endpoints:
- GET/POST /api/admin/experiments - List/Create experiments
- GET/PUT/DELETE /api/admin/experiments/{key} - CRUD
- PUT /api/admin/experiments/{key}/status - Update status
- GET /api/admin/experiments/{key}/results - Get results
- POST /api/admin/experiments/{key}/aggregate - Trigger aggregation
- POST /api/admin/experiments/{key}/ai-analysis - AI analysis
- GET /api/admin/experiments/{key}/quick-recommendation
- GET /api/admin/experiments/{key}/trend - Daily trend
- GET /api/admin/experiments/{key}/hourly-trend - Hourly trend
"""
...
def update_experiment(experiment_key: str, req: ExperimentUpdateRequest, admin: dict = Depends(require_admin)):
...
def update_experiment_status(experiment_key: str, req: StatusUpdateRequest, admin: dict = Depends(require_admin)):
...
def get_ai_analysis(experiment_key: str, req: Optional[AIAnalysisRequest] = None, admin: dict = Depends(require_admin)):
...
def get_experiment_trend(experiment_key: str, days: int = 30, admin: dict = Depends(require_admin)):
...
def get_hourly_trend(experiment_key: str, hours: int = 24, admin: dict = Depends(require_admin)):
