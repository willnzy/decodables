"""
Admin Metrics Router - System metrics and analytics

@module routers.admin_metrics
@version 3.24

Endpoints:
- GET /api/admin/metrics/daily - Daily metrics
- GET /api/admin/metrics/monthly - Monthly metrics
- GET /api/admin/metrics/retention - User retention
- GET /api/admin/metrics/funnel - Conversion funnel
- GET /api/admin/metrics/errors - Error metrics
- GET /api/admin/metrics/dau-trend - DAU trend
- POST /api/admin/metrics/refresh - Refresh metrics
"""
