"""
Admin Logs Router - Error logs and operation logs for admins

@module routers.admin_logs
@version 3.24

Endpoints:
- GET /api/admin/error-logs - Get error logs with filtering
- GET /api/admin/error-logs/stats - Get error statistics
- GET /api/admin/logs - Get admin operation logs
- GET /api/admin/logs/export - Export operation logs as CSV
"""
