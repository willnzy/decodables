...
@module routers.user_assets
@version 3.24

Endpoints:
- GET /api/user/assets - Get user assets
- POST /api/user/assets - Upload asset
- DELETE /api/user/assets/{asset_id} - Delete asset
- POST /api/user/assets/from-url - Add asset from URL
- GET /api/user/assets/check-url - Check URL validity
- POST /api/user/assets/{asset_id}/increment-usage - Increment usage
- GET /api/user/assets/dashboard - Asset dashboard
- GET /api/user/assets/seller-stats - Seller stats
- GET /api/user/assets/deleted - Get deleted assets
- POST /api/user/assets/{asset_id}/restore - Restore asset
"""
