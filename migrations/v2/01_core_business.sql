...
-- Version: 1.1.0
-- Created: 2026-01-10
-- Updated: 2026-01-21 (添加 p_resource_type 参数)
...
Parameters:
- p_resource_type: Top-level filter (asset/project)
- p_category: Second-level filter (clipart/sticker/template etc.)
Performance: 5x-10x faster than separate queries.
