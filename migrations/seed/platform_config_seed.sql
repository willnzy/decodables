...
-- PRICING (8 records)
-- ============================================================================
('T2_PLAN_PRICE', '6.9', 'number', 'pricing', 't2 monthly price', true, true),
('T2_PLAN_ORIGINAL_PRICE', '9.9', 'number', 'pricing', 't2 original price (for display)', true, true),
('T2_MONTHLY_CREDITS', '100', 'number', 'pricing', 't2 monthly credits (sync with tier.t2.monthly_credits)', true, true),
('T3_PLAN_PRICE', '9.9', 'number', 'pricing', 't3 monthly price', true, true),
('T3_PLAN_ORIGINAL_PRICE', '15.9', 'number', 'pricing', 't3 original price (for display)', true, true),
...
('CREDITS_TIERS', '[{"id":"credits_100","credits":100,"originalPrice":2.99,"currentPrice":2.99,"discount":null,"proDiscount":20},{"id":"credits_500","credits":500,"originalPrice":14.95,"currentPrice":13.46,"discount":10,"proDiscount":20,"popular":true},{"id":"credits_2000","credits":2000,"originalPrice":59.80,"currentPrice":47.84,"discount":20,"proDiscount":20}]', 'json', 'pricing', 'Credits purchase tiers', true, true),
