-- ============================================================================
-- HELP ARTICLES SEED FILE (Manual + FAQ + Troubleshooting)
-- ============================================================================
-- Contains: Manual articles (12) + FAQ articles (6) + Troubleshooting articles (8)
-- Merged from: articles_manual_seed.sql + articles_faq_troubleshoot_seed.sql
--
-- Total: 26 articles
--   - manual: 12 articles (help documentation and tutorials)
--   - faq: 6 articles (frequently asked questions by category)
--   - troubleshooting: 8 articles (common errors and solutions)
--
-- Template Variables:
--   - {{tiers.t1.signupBonus}} - Free tier signup bonus
--   - {{tiers.t2.monthlyPrice}} - Starter tier monthly price
--   - {{tiers.t3.monthlyPrice}} - Pro tier monthly price
--   - {{creditCosts.ai_image}} - AI image generation cost
--   - {{creditCosts.ocr}} - OCR/Smart Scan cost
--   - {{marketplace.seller_share_percent}} - Seller revenue share
--   - {{site.email}} - Support email
--   - {{trial.duration_days}} - Trial period days
--
-- Usage:
--   psql $DATABASE_URL -f migrations/seed/articles_help_seed.sql
--
-- Note: Uses gen_random_uuid() for ID generation
-- ============================================================================


-- ============================================================================
-- PART 1: MANUAL ARTICLES (12 records)
-- ============================================================================
-- Help documentation and tutorials for the Manual page
...
-- ============================================================================
-- PART 2: FAQ ARTICLES (6 records)
-- ============================================================================
-- FAQ articles grouped by tag for display in the Manual page
...
-- ============================================================================
-- PART 3: TROUBLESHOOTING ARTICLES (8 records)
-- ============================================================================
...
-- ============================================================================
-- END OF HELP ARTICLES SEED DATA
-- ============================================================================
