...
端点: POST /webhooks/clerk, POST /webhooks/stripe
...
class TestWebhooksAPI:
    ...
    def test_get_webhooks_success(self, auth_headers):
        """获取 Webhooks 成功"""
        # TODO: 根据实际端点调整
        response = client.get("/api/v2/webhooks", headers=auth_headers)
    ...
    def test_webhooks_with_mock(self, mock_supabase, auth_headers):
        """使用 mock 测试 Webhooks"""
        # Mock Supabase 响应
