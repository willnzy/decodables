"""
测试 api/admin/metrics_api.py

端点: GET /admin/metrics/daily
...
class TestAdminMetricsAPI:
    ...
    def test_admin_metrics_requires_admin_role(self, auth_headers):
        """非管理员应返回 403"""
        # TODO: 配置 dependencies.py 中的 require_admin 来正确验证权限
        response = client.get("/api/v2/admin/metrics", headers=auth_headers)
    ...
    def test_admin_metrics_success(self, mock_supabase, admin_headers):
        ...
        response = client.get("/api/v2/admin/metrics", headers=admin_headers)
