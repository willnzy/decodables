...
class TestAdminEventsAPI:
    ...
    def test_admin_events_success(self, mock_supabase, admin_headers):
        ...
        response = client.get("/api/v2/admin/events", headers=admin_headers)
