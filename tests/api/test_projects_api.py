...
Endpoints:
- GET /api/v2/projects - List user projects with pagination
- GET /api/v2/projects/dashboard - Dashboard view with filters
...
- DELETE /api/v2/projects/{id} - Delete project (soft/permanent)
- POST /api/v2/projects/{id}/restore - Restore deleted project
...
# ==========================================
# GET /api/v2/projects Tests
# ==========================================

class TestListProjects:
    """Tests for GET /api/v2/projects endpoint."""
    ...
    def test_list_projects_with_pagination(
        ...
        # Act
        response = client.get(
            "/api/v2/projects?page=2&limit=10",
            headers=auth_headers,
        )
    ...
    def test_list_projects_with_search(
        ...
        # Act
        response = client.get(
            "/api/v2/projects?search=Project 1",
            headers=auth_headers,
        )
    ...
    def test_list_projects_without_canvas_data(
        ...
        # Act
        response = client.get(
            "/api/v2/projects?include_canvas_data=false",
            headers=auth_headers,
        )
...
# ==========================================
# GET /api/v2/projects/dashboard Tests
# ==========================================

class TestDashboardProjects:
    """Tests for GET /api/v2/projects/dashboard endpoint."""
    ...
    def test_dashboard_all_view(
        ...
        Given: User with projects
        When: GET /api/v2/projects/dashboard?view=all
        ...
        # Act
        response = client.get(
            "/api/v2/projects/dashboard?view=all",
            headers=auth_headers,
        )
    ...
    def test_dashboard_bought_view(
        ...
        When: GET /api/v2/projects/dashboard?view=bought
        ...
        # Act
        response = client.get(
            "/api/v2/projects/dashboard?view=bought",
            headers=auth_headers,
        )
    ...
    def test_dashboard_selling_view(
        ...
        When: GET /api/v2/projects/dashboard?view=selling
        ...
        # Act
        response = client.get(
            "/api/v2/projects/dashboard?view=selling",
            headers=auth_headers,
        )
...
# ==========================================
# GET /api/v2/projects/deleted Tests
# ==========================================

class TestListDeletedProjects:
    """Tests for GET /api/v2/projects/deleted endpoint."""
    ...
    def test_list_deleted_projects_success(
        ...
        When: GET /api/v2/projects/deleted
...
# ==========================================
# GET /api/v2/projects/seller-stats Tests
# ==========================================

class TestGetSellerStats:
    """Tests for GET /api/v2/projects/seller-stats endpoint."""
    ...
    def test_get_seller_stats_success(
        ...
        Given: User with selling projects
        When: GET /api/v2/projects/seller-stats
...
class TestCreateProject:
    ...
    def test_create_project_success(
        ...
        When: POST /api/v2/projects with title
    ...
    def test_create_project_default_title(
        ...
        When: POST /api/v2/projects without title
...
class TestGetProject:
    ...
    def test_get_project_access_denied(
        ...
        # Act
        response = client.get(
            "/api/v2/projects/project_other_user",
            headers=auth_headers,
        )
...
class TestUpdateProject:
    ...
    def test_update_project_success(
        ...
        Given: User owns the project
        When: PUT /api/v2/projects/{id} with new title
...
# ==========================================
# DELETE /api/v2/projects/{id} Tests
# ==========================================

class TestDeleteProject:
    """Tests for DELETE /api/v2/projects/{id} endpoint."""
    ...
    def test_delete_project_soft_delete(
        ...
        Given: User owns the project
        When: DELETE /api/v2/projects/{id} with permanent=false
        ...
        response = client.delete(
            "/api/v2/projects/project_123?permanent=false",
            headers=auth_headers,
        )
    ...
    def test_delete_project_permanent(
        ...
        Given: User owns the project
        When: DELETE /api/v2/projects/{id} with permanent=true
        ...
        # Act
        response = client.delete(
            "/api/v2/projects/project_123?permanent=true",
            headers=auth_headers,
        )
    ...
    def test_delete_project_not_found(
        ...
        Given: Invalid project ID
        When: DELETE /api/v2/projects/{id}
        Then: Returns 404 Not Found
        """
        # Arrange
        mock_get_user.return_value = mock_free_user
...
# ==========================================
# POST /api/v2/projects/{id}/restore Tests
# ==========================================

class TestRestoreProject:
    """Tests for POST /api/v2/projects/{id}/restore endpoint."""
    ...
    def test_restore_project_success(
        ...
        When: POST /api/v2/projects/{id}/restore
        ...
        # Act
        response = client.post(
            "/api/v2/projects/project_123/restore",
            headers=auth_headers,
        )
    ...
    def test_restore_project_not_found(
        ...
        # Act
        response = client.post(
            "/api/v2/projects/invalid_id/restore",
            headers=auth_headers,
        )
...
# ==========================================
# POST /api/v2/projects/{id}/duplicate Tests
# ==========================================

class TestDuplicateProject:
    """Tests for POST /api/v2/projects/{id}/duplicate endpoint."""
    ...
    def test_duplicate_project_success(
        ...
        When: POST /api/v2/projects/{id}/duplicate
        ...
        # Act
        response = client.post(
            "/api/v2/projects/project_123/duplicate",
            headers=auth_headers,
        )
    ...
    def test_duplicate_project_not_found(
        ...
        # Act
        response = client.post(
            "/api/v2/projects/invalid_id/duplicate",
            headers=auth_headers,
        )
...
GET /api/v2/projects/dashboard:
✅ All view
✅ Bought view
✅ Selling view

GET /api/v2/projects/deleted:
✅ Success

GET /api/v2/projects/seller-stats:
...
POST /api/v2/projects/{id}/duplicate:
