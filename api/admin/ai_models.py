...
async def update_text_config(req: TextModelConfigUpdate, admin: dict = Depends(require_admin)):
...
async def update_image_config(req: ImageModelConfigUpdate, admin: dict = Depends(require_admin)):
...
async def update_admin_config(admin: dict = Depends(require_admin)):
...
async def update_canary_config(req: CanaryConfigUpdate, admin: dict = Depends(require_admin)):
...
async def toggle_provider(req: ProviderToggleRequest, admin: dict = Depends(require_admin)):
