"""
Admin Tasks API - Background task management.

@module api.admin.tasks_api
@version 1.0.0

Endpoints:
- GET /tasks/status - Get task status
- GET /tasks/logs - Get task logs
- GET /tasks/health - Get task health
- POST /tasks/{task_name}/run - Run task manually
"""
...
router = APIRouter(prefix="/tasks", tags=["admin-tasks-v2"])
