...
@module api.webhooks_api
@version 2.0.0

Endpoints:
- POST /api/v2/webhooks/clerk - Clerk user events
- POST /api/v2/webhooks/stripe - Stripe payment events

Note: Both v1 (/api/webhooks/*) and v2 (/api/v2/webhooks/*) URLs are supported.
...
async def clerk_webhook(request: Request):
    ...
    **Update webhook URL in Clerk Dashboard:**
    ...
    4. Update endpoint URL to: https://your-domain.com/api/v2/webhooks/clerk
...
async def stripe_webhook(request: Request, stripe_signature: str = Header(None)):
    ...
    **Update webhook URL in Stripe Dashboard:**
    ...
    3. Update "Endpoint URL" to: https://your-domain.com/api/v2/webhooks/stripe
