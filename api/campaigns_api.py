"""
Campaigns API - Marketing campaigns endpoints.

@module api.campaigns_api
@version 1.0.0

Endpoints:
- GET /api/v2/campaigns/active - Get active campaigns
- POST /api/v2/campaigns/{id}/claim - Claim campaign reward
- POST /api/v2/campaigns/{id}/dismiss - Dismiss notification
"""
