"""
Public Experiments API - A/B Testing public endpoints.

@module api.experiments_api
@version 2.0.0

Endpoints:
- POST /api/v2/experiments/{key}/assign - Get variant assignment
- POST /api/v2/experiments/{key}/exposure - Track exposure
- POST /api/v2/experiments/{key}/conversion - Track conversion
- GET /api/v2/experiments/user/{identifier} - Get user experiments
"""
