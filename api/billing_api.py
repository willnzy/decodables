...
Endpoints:
- GET /api/v2/billing/credits - Get user credits
- GET /api/v2/billing/transactions - Get transaction history
- POST /api/v2/billing/credits/deduct - Deduct credits (internal)
- POST /api/v2/billing/credits/add - Add credits (internal)
"""
