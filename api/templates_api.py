"""
Templates API - User prompt templates management.

@module api.templates_api
@version 1.0.0

Endpoints:
Asset Prompt Templates (5W1H):
- GET /api/v2/templates/asset - List templates
- POST /api/v2/templates/asset - Create template
- PUT /api/v2/templates/asset/{id} - Update template
- DELETE /api/v2/templates/asset/{id} - Delete template
- POST /api/v2/templates/asset/{id}/use - Mark as used

Page Prompt Templates (AI Design Page):
- GET /api/v2/templates/page - List templates
- POST /api/v2/templates/page - Create template
- PUT /api/v2/templates/page/{id} - Update template
- DELETE /api/v2/templates/page/{id} - Delete template
- POST /api/v2/templates/page/{id}/use - Mark as used
"""
