"""
Logs API - Error logging endpoints.

@module api.logs_api
@version 1.0.0

Endpoints:
- POST /api/v2/logs/error - Log single error
- POST /api/v2/logs/errors - Log batch errors
...
router = APIRouter(prefix="/api/v2/logs", tags=["logs-v2"])
