...
@module api.generation_api
@version 1.0.0

Endpoints:
- POST /api/v2/generate/images - Sync image generation
- POST /api/v2/generate/images/async - Async image generation
- POST /api/v2/generate/story - Generate story JSON
- POST /api/v2/generate/inspiration - AI inspiration suggestions
- POST /api/v2/generate/pdf - PDF generation
"""
...
router = APIRouter(prefix="/api/v2/generate", tags=["generation-v2"])
