"""
Generations API - User generation history management.

@module api.generations_api
@version 1.0.0

Endpoints:
- GET /api/v2/generations/history - Get generation history
- POST /api/v2/generations/{id}/favorite - Toggle favorite
- DELETE /api/v2/generations/{id} - Delete single generation
- DELETE /api/v2/generations/batch - Clear history (batch delete)
"""
...
router = APIRouter(prefix="/api/v2/generations", tags=["generations-v2"])
