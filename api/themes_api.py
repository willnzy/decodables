"""
Themes API - Holiday themes endpoint.

@module api.themes_api
@version 1.0.0

Endpoints:
- GET /api/v2/themes/current - Get current active theme
"""
...
router = APIRouter(prefix="/api/v2/themes", tags=["themes-v2"])
