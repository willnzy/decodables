"""
Payment API - Payment and checkout endpoints.

@module api.payment_api
@version 1.0.0

Endpoints:
- POST /api/v2/payment/checkout - Create checkout session
- POST /api/v2/payment/portal - Get billing portal URL
"""
...
router = APIRouter(prefix="/api/v2/payment", tags=["payment-v2"])
