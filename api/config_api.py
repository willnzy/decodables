"""
Config API - Public configuration endpoints.

@module api.config_api
@version 1.0.0

Endpoints:
- GET /api/v2/configs - Get all configs
- GET /api/v2/configs/{key} - Get single config
- GET /api/v2/configs/group/{group_name} - Get config group
"""
...
router = APIRouter(prefix="/api/v2/configs", tags=["config-v2"])
