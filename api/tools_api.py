"""
Tools API - PDF preview and OCR tools.

@module api.tools_api
@version 1.0.0

Endpoints:
- POST /api/v2/tools/pdf-preview - Convert PDF to preview images
- POST /api/v2/tools/ocr - OCR processing
"""
