...
Usage:
    python -m application.services.experiments.aggregator              # Run all tasks
    python -m application.services.experiments.aggregator --aggregate  # Aggregation only
    python -m application.services.experiments.aggregator --schedule   # Scheduling only
"""
