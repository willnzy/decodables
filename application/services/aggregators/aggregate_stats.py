...
@module application.services.aggregators.aggregate_stats
@version 3.24

Usage:
    python -m application.services.aggregators.aggregate_stats              # Run all
    python -m application.services.aggregators.aggregate_stats --daily      # Daily only
    python -m application.services.aggregators.aggregate_stats --hourly     # Hourly only
"""
...
from .base import log, get_supabase
...
from .marketplace_stats import aggregate_marketplace_stats
