...
- 相关模块：积分账户与扣费
- 相关文档：`docs/v2/03-business/entitlement/billing-lifecycle.md`

## 证据与验证

- 关键证据来源：`decodables/domains/billing/`、`decodables/infrastructure/repositories/`
...
| 日期 | 版本 | 变更内容 | 负责人 |
|------|------|----------|--------|
| 2026-02-04 | 3.1.0 | 结构对齐模板 | Docs Working Group |
