...
- 相关模块：Entitlement 权限矩阵
- 相关文档：`docs/v2/03-business/entitlement/tier-config.md`

## 证据与验证

- 关键证据来源：`decodables/docs/shared/entitlement/permission-matrix.md`
...
| 日期 | 版本 | 变更内容 | 负责人 |
|------|------|----------|--------|
| 2026-02-04 | 2.4.0 | 结构对齐模板 | Docs Working Group |
