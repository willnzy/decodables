...
**source_repo**: both  
**sync_required**: yes  
**来源/依据**: `decodables-fe/app/privacy-policy/`

---

## 背景

- 问题或机会: 需要对隐私合规与数据使用规则进行清晰披露
- 目标与非目标: 目标是提供可更新的法律文本展示；非目标是编辑工具
...
- 关键证据来源：`decodables-fe/app/privacy-policy/`
