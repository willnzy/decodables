...
**source_repo**: both  
**sync_required**: yes  
**来源/依据**: `decodables-fe/app/manual/[slug]/page.tsx`

---

## 背景

- 问题或机会: 提供 SEO 友好的教程详情页
- 目标与非目标: 目标是展示文章内容与关联推荐；非目标是编辑器内帮助
...
- 关键结论与约束: SSG 参数生成 + ISR（1h）+ Article Schema
...
- 关键证据来源：`decodables-fe/app/manual/[slug]/page.tsx`
