...
from shared.ai.story_generator import generate_story_json, client as openai_client # reuse client
from shared.ai.prompt_enhancer import enhance_prompt, enhance_asset_prompt  # AI prompt enhancement
